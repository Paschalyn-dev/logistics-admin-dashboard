...
export const customerAPIUrl= {
    ...
    searchTransactions: ({inputField, searchFields}:any) => `https://logapi.logistixng.com/api/b2c/parcels/range?search=${inputField?.activeShipments}&searchFields=${searchFields?.activeShipments}&query={%22company%22:${company}}&range=[]`,
    // searchTransactions: ({inputField, searchFields, amountStart, amountEnd, createdAtStart, createdAtEnd}:any) => `https://logapi.logistixng.com/api/b2c/parcels/range?search=${inputField?.transactionsRange}&searchFields=${searchFields?.transactionsRange}&query={%22company%22:${company}}&range=[{%22field%22:%22createdAt%22,%22start%22:%22${createdAtStart?.transactionsRange}%22,%22end%22:%22${createdAtEnd?.transactionsRange}%22},{%22field%22:%22amount%22,%22start%22:%22${amountStart?.transactionsRange}%22,%22end%22:%22${amountEnd?.transactionsRange}%22}]`,
