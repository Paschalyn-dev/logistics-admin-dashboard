...
export const staffAPIURL = {
    sendMessage: `https://logapi.logistixng.com/api/b2b/cakenus/inmail`,
    changeDp: `https://logapi.logistixng.com/api/b2b/${data}/staff/dp`,
    ...
    trackShipment: `https://radar.logistix.africa/track/log-cakenus-9se3of`,
    editDispatcher: (id: any) => `https://logapi.logistixng.com/api/b2b/${data}/rider/${id}`,
    editStaff: (id: any) => `https://logapi.logistixng.com/api/b2b/${data}/staff/${id}`,
