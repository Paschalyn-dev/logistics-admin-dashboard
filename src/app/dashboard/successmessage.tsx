...
export default function SuccessMessage({messageTitle, id, name, successMessageShow}: SuccessType){
    ...
    "animate__animated animate__slideInRight z-100 flex flex-col fixed bg-red-500 shadow-sm laptop:text-lg top-24 phone:text-base h-16 z-20 justify-center items-center text-white rounded-xl px-2 py-3 right-5"
